...
| 排名 | 嘉宾 / 主题 | 官方 Episode | 分类 |
| ---: | --- | --- | --- |
| 1 | Jensen Huang | [#494 – Jensen Huang: NVIDIA – The $4 Trillion Company & the AI Revolution](https://lexfridman.com/jensen-huang) | AI 算力 / NVIDIA / 数据中心 |
| 2 | Sam Altman | [#419 – Sam Altman: OpenAI, GPT-5, Sora, Board Saga, Elon Musk, Ilya, Power & AGI](https://lexfridman.com/sam-altman-2) | OpenAI / AGI / 产品战略 |
| 3 | Dario Amodei | [#452 – Dario Amodei: Anthropic CEO on Claude, AGI & the Future of AI & Humanity](https://lexfridman.com/dario-amodei) | Anthropic / Claude / AI 安全 |
| 4 | Demis Hassabis | [#475 – Demis Hassabis: Future of AI, Simulating Reality, Physics and Video Games](https://lexfridman.com/demis-hassabis-2) | DeepMind / AGI / 世界模型 |
| 5 | Dylan Patel & Nathan Lambert | [#459 – DeepSeek, China, OpenAI, NVIDIA, xAI, TSMC, Stargate, and AI Megaclusters](https://lexfridman.com/deepseek-dylan-patel-nathan-lambert) | AI 产业链 / 算力 / DeepSeek |
| 6 | Andrej Karpathy | [#333 – Andrej Karpathy: Tesla AI, Self-Driving, Optimus, Aliens, and AGI](https://lexfridman.com/andrej-karpathy) | 自动驾驶 / Tesla AI / 机器人 |
| 7 | Cursor Team | [#447 – Cursor Team: Future of Programming with AI](https://lexfridman.com/cursor-team) | AI 编程 / IDE / 软件工程 |
| 8 | Chris Lattner | [#381 – Chris Lattner: Future of Programming and AI](https://lexfridman.com/chris-lattner-3) | 编程语言 / 编译器 / AI 工程 |
| 9 | Yann LeCun | [#416 – Yann Lecun: Meta AI, Open Source, Limits of LLMs, AGI & the Future of AI](https://lexfridman.com/yann-lecun-3) | Meta AI / 开源 / LLM 局限 |
| 10 | George Hotz | [#387 – George Hotz: Tiny Corp, Twitter, AI Safety, Self-Driving, GPT, AGI & God](https://lexfridman.com/george-hotz-3) | 开源 AI / 自动驾驶 / 黑客视角 |
| 11 | Aravind Srinivas | [#434 – Aravind Srinivas: Perplexity CEO on Future of AI, Search & the Internet](https://lexfridman.com/aravind-srinivas) | AI 搜索 / RAG / 互联网入口 |
| 12 | Elon Musk & Neuralink Team | [#438 – Elon Musk: Neuralink and the Future of Humanity](https://lexfridman.com/elon-musk-and-neuralink-team) | 脑机接口 / Neuralink / 人机融合 |
| 13 | Marc Raibert | [#412 – Marc Raibert: Boston Dynamics and the Future of Robotics](https://lexfridman.com/marc-raibert) | 机器人 / Boston Dynamics |
| 14 | Jim Keller | [#162 – Jim Keller: The Future of Computing, AI, Life, and Consciousness](https://lexfridman.com/jim-keller-2) | 芯片 / 计算架构 / AI 硬件 |
| 15 | John Carmack | [#309 – John Carmack: Doom, Quake, VR, AGI, Programming, Video Games, and Rockets](https://lexfridman.com/john-carmack) | 极致工程 / 编程 / AGI |
| 16 | Ilya Sutskever | [#94 – Ilya Sutskever: Deep Learning](https://lexfridman.com/ilya-sutskever) | 深度学习 / OpenAI |
| 17 | Andrew Ng | [#73 – Andrew Ng: Deep Learning, Education, and Real-World AI](https://lexfridman.com/andrew-ng) | AI 教育 / 落地应用 |
| 18 | Francois Chollet | [#120 – Francois Chollet: Measures of Intelligence](https://lexfridman.com/francois-chollet-2) | 智能度量 / Keras / AGI 反思 |
| 19 | David Silver | [#86 – David Silver: AlphaGo, AlphaZero, and Deep Reinforcement Learning](https://lexfridman.com/david-silver) | 强化学习 / AlphaGo / DeepMind |
| 20 | Chris Urmson | [Chris Urmson: Self-Driving Cars at Aurora, Google, CMU, and DARPA](https://lexfridman.com/chris-urmson) | 自动驾驶 / Aurora / Google |
| 21 | Elon Musk | [Elon Musk: Tesla Autopilot](https://lexfridman.com/elon-musk) | Tesla Autopilot / 自动驾驶 |
| 22 | Kyle Vogt | [Kyle Vogt: Cruise Automation](https://lexfridman.com/kyle-vogt) | Robotaxi / Cruise / 自动驾驶 |
| 23 | Mark Zuckerberg | [#383 – Mark Zuckerberg: Future of AI at Meta, Facebook, Instagram, and WhatsApp](https://lexfridman.com/mark-zuckerberg-2) | Meta AI / 开源模型 / 社交产品 |
| 24 | Sundar Pichai | [#471 – Sundar Pichai: CEO of Google and Alphabet](https://lexfridman.com/sundar-pichai) | Google / Gemini / 搜索与平台 |
| 25 | Stephen Wolfram | [#376 – Stephen Wolfram: ChatGPT and the Nature of Truth, Reality & Computation](https://lexfridman.com/stephen-wolfram-4) | ChatGPT / 计算理论 / 知识表达 |
| A | DHH | [#474 – DHH: Future of Programming, AI, Ruby on Rails, Productivity & Parenting](https://lexfridman.com/dhh-david-heinemeier-hansson) | AI 编程 / 软件工程 |
| A | ThePrimeagen | [#461 – ThePrimeagen: Programming, AI, ADHD, Productivity, Addiction, and God](https://lexfridman.com/theprimeagen) | 程序员工作流 / AI 工具 |
| A | Marc Andreessen | [#386 – Marc Andreessen: Future of the Internet, Technology, and AI](https://lexfridman.com/marc-andreessen) | 科技投资 / 互联网 / AI |
| A | Robert Playter | [#374 – Robert Playter: Boston Dynamics CEO on Humanoid and Legged Robotics](https://lexfridman.com/robert-playter) | 人形机器人 / 足式机器人 |
| A | Jim Keller | [Jim Keller: Moore's Law, Microprocessors, Abstractions, and First Principles](https://lexfridman.com/jim-keller) | 微处理器 / 摩尔定律 / 第一性原理 |
...
| 线索 | 推荐顺序 | 解决的问题 |
| --- | --- | --- |
| AI 产业与算力 | Jensen Huang → DeepSeek/Dylan Patel & Nathan Lambert → Jim Keller | 谁控制算力、供应链、芯片和数据中心，模型能力为什么受物理世界约束 |
| 模型公司与 AGI 路线 | Sam Altman → Dario Amodei → Demis Hassabis → Yann LeCun → Mark Zuckerberg → Sundar Pichai | OpenAI、Anthropic、DeepMind、Meta、Google 对 AGI、开源、安全和产品入口的分歧 |
| AI 编程与工程生产力 | Cursor Team → Chris Lattner → DHH → ThePrimeagen → John Carmack | AI 如何改变 IDE、编译器、语言、团队和个人编程工作流 |
| 自动驾驶与机器人 | Andrej Karpathy → Elon Musk → Chris Urmson → Kyle Vogt → Marc Raibert → Robert Playter | 端到端学习、车队数据、robotaxi、腿足机器人和真实世界部署的差异 |

## 1. Jensen Huang

[官方 Episode：#494 – Jensen Huang: NVIDIA – The $4 Trillion Company & the AI Revolution](https://lexfridman.com/jensen-huang)

扩展笔记：[Jensen Huang 访谈笔记：NVIDIA、AI 工厂与算力革命](/writing/lex-jensen-huang-nvidia-ai-revolution/)
...
扩展笔记：[Sam Altman 访谈笔记：OpenAI、Sora、GPT-5 与 AGI 权力结构](/writing/lex-sam-altman-openai-gpt5-sora-agi/)
...
扩展笔记：[Dario Amodei 访谈笔记：Anthropic、Claude、Scaling 与 AI Safety](/writing/lex-dario-amodei-anthropic-claude-agi/)
...
扩展笔记：[Demis Hassabis 访谈笔记：DeepMind、世界模型、科学发现与 AGI](/writing/lex-demis-hassabis-ai-reality-science/)
...
扩展笔记：[DeepSeek 访谈笔记：R1、开源模型、GPU、TSMC 与 AI Megaclusters](/writing/lex-deepseek-ai-megaclusters/)
...
扩展笔记：[Andrej Karpathy 访谈笔记：Tesla AI、自动驾驶、Software 2.0 与 AGI](/writing/lex-andrej-karpathy-tesla-ai-self-driving/)
...
扩展笔记：[Cursor Team 访谈笔记：AI IDE、代码编辑、Agent 与未来编程](/writing/lex-cursor-team-ai-programming/)
...
扩展笔记：[Chris Lattner 访谈笔记：Mojo、编译器、AI Runtime 与未来编程](/writing/lex-chris-lattner-programming-ai-mojo/)
...
扩展笔记：[Yann LeCun 访谈笔记：LLM 局限、JEPA、开源与 AGI 路线之争](/writing/lex-yann-lecun-meta-ai-open-source-jepa/)
...
扩展笔记：[George Hotz 访谈笔记：tiny corp、开源硬件、自动驾驶与黑客式 AI](/writing/lex-george-hotz-tinycorp-ai-safety-self-driving/)
...
扩展笔记：[Aravind Srinivas 访谈笔记：Perplexity、AI 搜索与互联网入口](/writing/lex-aravind-srinivas-perplexity-ai-search/)
...
扩展笔记：[Elon Musk 与 Neuralink 团队访谈笔记：脑机接口、人机融合与真实用户](/writing/lex-elon-musk-neuralink-future-humanity/)
...
扩展笔记：[Marc Raibert 访谈笔记：Boston Dynamics、腿足机器人与运动智能](/writing/lex-marc-raibert-boston-dynamics-robotics/)
...
扩展笔记：[Jim Keller 访谈笔记：处理器、AI 硬件、Dojo 与计算第一性原理](/writing/lex-jim-keller-computing-ai-consciousness/)
...
扩展笔记：[Ilya Sutskever 访谈笔记：深度学习、GPT-2、推理与 AGI 信念](/writing/lex-ilya-sutskever-deep-learning/)
