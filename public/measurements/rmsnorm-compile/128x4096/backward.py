...
# kernel path: /tmp/torchinductor_root/b4/cb465vdrqzoao3ouua4ra3qyyhnmp3xoi6n5wl655wlynsbo46vp.py
...
#   x_hat => mul
# Graph fragment:
#   %arg2_1 : Tensor "bf16[128, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg2_1]
#   %arg0_1 : Tensor "bf16[128, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg0_1]
#   %arg3_1 : Tensor "f32[128, 1][1, 1]cuda:0" = PlaceHolder[target=arg3_1]
#   %sum_2 : Tensor "f32[4096][1]cuda:0" = PlaceHolder[target=sum_2]
#   %convert_element_type_2 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg2_1, torch.float32), kwargs = {})
#   %convert_element_type : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
#   %mul : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type, %arg3_1), kwargs = {})
#   %mul_6 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_2, %mul), kwargs = {})
...
def triton_red_fused__to_copy_mul_sum_0(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp2 = tl.load(in_ptr1 + (x0 + 4096*r0_1), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
...
# kernel path: /tmp/torchinductor_root/6m/c6mn7iztiusid4varsl7afrglg3ojmnhld5c2e43d6duj35crgk4.py
...
#   %arg0_1 : Tensor "bf16[128, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg0_1]
#   %arg3_1 : Tensor "f32[128, 1][1, 1]cuda:0" = PlaceHolder[target=arg3_1]
#   %sum_1 : Tensor "f32[128, 1][1, 128]cuda:0" = PlaceHolder[target=sum_1]
#   %convert_element_type_2 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg2_1, torch.float32), kwargs = {})
...
#   %mul_1 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_2, %convert_element_type_1), kwargs = {})
#   %mul_3 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg3_1, %mul_1), kwargs = {})
#   %convert_element_type : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[128, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%arg3_1, 3), kwargs = {})
#   %mul_4 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type, %pow_1), kwargs = {})
#   %mul_2 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_1, %convert_element_type), kwargs = {})
#   %sum_1 : Tensor "f32[128, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_2, [1], True), kwargs = {})
#   %mul_5 : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_4, %sum_1), kwargs = {})
#   %div : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_5, 4096), kwargs = {})
#   %sub : Tensor "f32[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_3, %div), kwargs = {})
#   %convert_element_type_3 : Tensor "bf16[128, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sub, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg3_1, (128, 1), (1, 1))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf3 = empty_strided_cuda((4096, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [g, x, x_hat, mul_6, dgamma, to_1], Original ATen: [aten._to_copy, aten.mul, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_0.run(arg2_1, arg0_1, arg3_1, buf3, 4096, 128, stream=stream0)
            buf1 = empty_strided_cuda((128, 4096), (4096, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [g, gamma, dx_hat, mul_3, x, pow_1, mul_4, mul_2, dr, mul_5, truediv, dx, to], Original ATen: [aten._to_copy, aten.mul, aten.pow, aten.sum, aten.div, aten.sub]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_div_mul_pow_sub_sum_1.run(arg2_1, arg1_1, arg0_1, arg3_1, buf1, 128, 4096, stream=stream0)
            del arg0_1
            del arg1_1
            del arg2_1
            del arg3_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((128, 4096), (4096, 1), device='cuda:0', dtype=torch.bfloat16)
    arg3_1 = rand_strided((128, 1), (1, 1), device='cuda:0', dtype=torch.float32)
