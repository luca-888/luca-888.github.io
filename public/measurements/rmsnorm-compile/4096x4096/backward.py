...
# kernel path: /tmp/torchinductor_root/vq/cvqivy4szqvdyhadbklin35ltmr2bwdbveyhc7ya6lbetlen74by.py
...
#   x_hat => mul
# Graph fragment:
#   %arg2_1 : Tensor "bf16[4096, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg2_1]
...
#   %convert_element_type_2 : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg2_1, torch.float32), kwargs = {})
#   %convert_element_type : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
#   %mul : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type, %arg3_1), kwargs = {})
#   %mul_6 : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_2, %mul), kwargs = {})
...
# kernel path: /tmp/torchinductor_root/rn/crn5eopftqdhmknugs2wm4234sezthrazjafs6piu37ku5pehasi.py
...
#   x_hat => mul
# Graph fragment:
#   %buf2 : Tensor "f32[4096, 32][1, 4096]cuda:0" = PlaceHolder[target=buf2]
...
# kernel path: /tmp/torchinductor_root/kk/ckkgsf32ncbwu5mblm2fer4vdbvhqgqta45uxdnis5ym7iai5qpu.py
...
#   %mul_1 : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_2, %convert_element_type_1), kwargs = {})
#   %mul_3 : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg3_1, %mul_1), kwargs = {})
#   %convert_element_type : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
...
#   %mul_4 : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type, %pow_1), kwargs = {})
#   %mul_2 : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_1, %convert_element_type), kwargs = {})
...
#   %mul_5 : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_4, %sum_1), kwargs = {})
#   %div : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_5, 4096), kwargs = {})
#   %sub : Tensor "f32[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_3, %div), kwargs = {})
#   %convert_element_type_3 : Tensor "bf16[4096, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sub, torch.bfloat16), kwargs = {})
...
def triton_red_fused__to_copy_div_mul_pow_sub_sum_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp5 = tl.load(in_ptr2 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp1 = tmp0.to(tl.float32)
        tmp3 = tmp2.to(tl.float32)
        tmp4 = tmp1 * tmp3
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp12 = tl.load(in_ptr0 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp14 = tl.load(in_ptr1 + (r0_1), r0_mask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp18 = tl.load(in_ptr2 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tl.store(out_ptr1 + (r0_1 + 4096*x0), tmp27, r0_mask)
''', device_str='cuda')
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf2 = empty_strided_cuda((4096, 32), (1, 4096), torch.float32)
            # Topologically Sorted Source Nodes: [g, x, x_hat, mul_6, dgamma], Original ATen: [aten._to_copy, aten.mul, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_0.run(arg2_1, arg0_1, arg3_1, buf2, 131072, 128, stream=stream0)
            buf4 = empty_strided_cuda((4096, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [g, x, x_hat, mul_6, dgamma, to_1], Original ATen: [aten._to_copy, aten.mul, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_mul_sum_1.run(buf2, buf4, 4096, 32, stream=stream0)
            del buf2
            buf1 = empty_strided_cuda((4096, 4096), (4096, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [g, gamma, dx_hat, mul_3, x, pow_1, mul_4, mul_2, dr, mul_5, truediv, dx, to], Original ATen: [aten._to_copy, aten.mul, aten.pow, aten.sum, aten.div, aten.sub]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_div_mul_pow_sub_sum_2.run(arg2_1, arg1_1, arg0_1, arg3_1, buf1, 4096, 4096, stream=stream0)
            del arg0_1
            del arg1_1
            del arg2_1
            del arg3_1
